...
def process_step4():
    ...
    success, message = step4_process_image('images/step3_green_mask.jpg', window_size=window_size)
    
    if success:
        # Save window size for step 6 - tbr revital - remove. why do we need window zise in step 6?
...
def step4_process_image(mask_path, window_size=10, threshold=0.6):
    ...
    try:
        ...
        cv2.imwrite('images/step4_density_mask.jpg', density_mask)
