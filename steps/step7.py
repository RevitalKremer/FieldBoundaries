...
def process_step7():
    # Use smoothed shape from step 6 instead of main shape
    success, message = step7_process_image('images/uploaded_image.jpg', 'images/step6_smoothed_shape.jpg')
    if success:
        return 'success'
    return message


def step7_process_image(original_image_path, smoothed_shape_path):
    ...
    try:
        ...
        # Save the result
        cv2.imwrite('images/step7_masked_field.jpg', result)
