...
def process_step8():
    ...
    success, message = generate_geojson('images/step6_smoothed_shape.jpg')
    if success:
...
def draw_geojson_on_image():
    ...
    try:
        ...
        masked_image = cv2.imread('images/step7_masked_field.jpg')
        ...
        cv2.imwrite('images/step8_final_with_boundary.jpg', original_image)
        return True
